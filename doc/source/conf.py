...
from dympy.__version__ import version as __version__
...
latex_documents = [
    (master_doc, 'dympy.tex', u'dympy Documentation',
...
man_pages = [
    (master_doc, 'dympy', u'dympy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dympy', u'dympy Documentation',
     author, 'dympy', 'Python-Dymola communication on windows',
     'Miscellaneous'),
]
